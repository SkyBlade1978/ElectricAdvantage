...
import zone.moddev.mc.electricadvantage.ElectricAdvantage;
import zone.moddev.mc.electricadvantage.entities.*;
import zone.moddev.mc.electricadvantage.graphics.*;
import zone.moddev.mc.electricadvantage.machines.*;
...
public abstract class Entities {
	...
	public static void registerRenderers(){
		...
		ClientRegistry.bindTileEntitySpecialRenderer(LaserTurretTileEntity.class, new zone.moddev.mc.electricadvantage.graphics.LaserTurretRenderer());
		ClientRegistry.bindTileEntitySpecialRenderer(ElectricDrillTileEntity.class, new zone.moddev.mc.electricadvantage.graphics.LaserDrillRenderer());
