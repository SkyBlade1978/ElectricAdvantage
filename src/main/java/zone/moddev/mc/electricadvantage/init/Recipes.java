...
import zone.moddev.mc.electricadvantage.compat.BaseMetalsCompat;
...
public abstract class Recipes {
	...
	public static void init(){
		...
		GameRegistry.addRecipe(new ShapelessOreRecipe(new ItemStack(Blocks.electric_track,1),Blocks.electric_conduit, zone.moddev.mc.poweradvantage.init.Blocks.steel_frame));
