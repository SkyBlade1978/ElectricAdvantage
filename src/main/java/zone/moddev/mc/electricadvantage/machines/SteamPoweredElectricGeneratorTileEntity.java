...
import static zone.moddev.mc.electricadvantage.machines.SteamPoweredElectricGeneratorBlock.STEAM_POWER;
...
public class SteamPoweredElectricGeneratorTileEntity extends ElectricGeneratorTileEntity{
	...
	public SteamPoweredElectricGeneratorTileEntity() {
		super("tile.electricadvantage.steam_powered_generator.name", 0, new ConduitType[]{Power.ELECTRIC_POWER,STEAM_POWER}, new float[]{1000f,32f});
	}
