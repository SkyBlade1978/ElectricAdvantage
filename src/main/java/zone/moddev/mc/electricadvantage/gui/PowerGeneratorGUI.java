...
import zone.moddev.mc.electricadvantage.machines.ElectricGeneratorTileEntity;
...
public class PowerGeneratorGUI extends SimpleMachineGUI{
	...
	public PowerGeneratorGUI() {
		super(new ResourceLocation(ElectricAdvantage.MODID+":textures/gui/container/electric_generator_gui.png"), new Integer2D[0]);
	}
...
guiContainer.drawTexturedModalRect(x+79, y+35, 0, 0, arrowLength, 17); // x, y, textureOffsetX, textureOffsetY, width, height)
	...
	public void drawGUIDecorations(Object srcEntity, GUIContainer guiContainer, int x, int y, float  z){
		if(srcEntity instanceof ElectricGeneratorTileEntity){
