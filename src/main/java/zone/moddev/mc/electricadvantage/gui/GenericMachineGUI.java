package zone.moddev.mc.electricadvantage.gui;

import zone.moddev.mc.electricadvantage.ElectricAdvantage;
import zone.moddev.mc.electricadvantage.machines.ElectricMachineTileEntity;
import cyano.poweradvantage.api.simple.SimpleMachineGUI;
import zone.moddev.mc.poweradvantage.math.Integer2D;
import net.minecraft.util.ResourceLocation;

public class GenericMachineGUI extends SimpleMachineGUI{

	public GenericMachineGUI() {
		super(new ResourceLocation(ElectricAdvantage.MODID+":textures/gui/container/electric_machine_gui.png"), new Integer2D[0]);
	}
...
guiContainer.drawTexturedModalRect(x+79, y+35, 0, 0, arrowLength, 17); // x, y, textureOffsetX, textureOffsetY, width, height)
	...
	public void drawGUIDecorations(Object srcEntity, GUIContainer guiContainer, int x, int y, float  z){
		if(srcEntity instanceof ElectricMachineTileEntity){
			...
			float charge = te.getEnergy() / te.getEnergyCapacity();
			GUIHelper.drawProgressBar(x+72, y+60, charge, guiContainer);
		}
	}
