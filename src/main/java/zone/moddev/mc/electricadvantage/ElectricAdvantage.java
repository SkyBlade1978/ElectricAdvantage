package zone.moddev.mc.electricadvantage;

import zone.moddev.mc.electricadvantage.init.*;
import zone.moddev.mc.electricadvantage.util.crafting.RecipeDeconstructor;
...
@Mod(modid = ElectricAdvantage.MODID, version = ElectricAdvantage.VERSION, name=ElectricAdvantage.NAME, 
		dependencies = "required-after:orespawn@[4.0.6,5.0.0);required-after:poweradvantage@[2.4.3.110021,);after:basemetals",
